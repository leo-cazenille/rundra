...
from rundra.adapters.remote import RemoteWorkspaceAllocator
from rundra.domain.models import Artifact, ArtifactKind, Command, NativeValue
...
class RsyncStager:
    ...
    def __init__(self, transport: Transport, *, executable: str = "rsync") -> None:
    ...
    def fetch(self, request: FetchRequest) -> FetchResult:
        """Result retrieval is introduced by M2.5."""
        raise RsyncStagerError("Remote result retrieval is unavailable before M2.5")
