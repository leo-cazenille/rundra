...
authorizes `target`. Pure plan output reports both the user-facing
`requested_location` and policy-derived `selected_location` without probing
caches or contacting the target. Local builds execute
